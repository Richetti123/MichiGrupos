...
const smsSpromote = () => { return '*𝑴𝑰𝑪𝑯𝑰𝑩𝑶𝑻 𝑨𝑵𝑼𝑵𝑪𝑰𝑨 𝑸𝑼𝑬 @user 𝘼𝙃𝙊𝙍𝘼 𝙀𝙎 𝘼𝘿𝙈𝙄𝙉 𝙀𝙉 𝙀𝙎𝙏𝙀 𝙂𝙍𝙐𝙋𝙊!!*'}
const smsSdemote = () => { return '*𝑴𝑰𝑪𝑯𝑰𝑩𝑶𝑻 𝑨𝑵𝑼𝑵𝑪𝑰𝑨 𝑸𝑼𝑬 @user 𝘿𝙀𝙅𝘼 𝘿𝙀 𝙎𝙀𝙍 𝘼𝘿𝙈𝙄𝙉 𝙀𝙉 𝙀𝙎𝙏𝙀 𝙂𝙍𝙐𝙋𝙊!!*'}
const smsSdesc = () => { return '*𝑴𝑰𝑪𝑯𝑰𝑩𝑶𝑻 𝑨𝑵𝑼𝑵𝑪𝑰𝑨 𝑸𝑼𝑬 𝙇𝘼 𝙉𝙐𝙀𝙑𝘼 𝘿𝙀𝙎𝘾𝙍𝙄𝙋𝘾𝙄𝙊𝙉 𝘿𝙀𝙇 𝙂𝙍𝙐𝙋𝙊 𝙀𝙎:*\n\n@desc'}
const smsSsubject = () => { return '*𝑴𝑰𝑪𝑯𝑰𝑩𝑶𝑻 𝑨𝑵𝑼𝑵𝑪𝑰𝑨 𝑸𝑼𝑬 𝙀𝙇 𝙉𝙐𝙀𝙑𝙊 𝙉𝙊𝙈𝘽𝙍𝙀 𝘿𝙀𝙇 𝙂𝙍𝙐𝙋𝙊 𝙀𝙎:*\n\n@subject'}
const smsSicon = () => { return '*𝑴𝑰𝑪𝑯𝑰𝑩𝑶𝑻 𝑨𝑵𝑼𝑵𝑪𝑰𝑨 𝑸𝑼𝑬 𝙎𝙀 𝙃𝘼 𝘾𝘼𝙈𝘽𝙄𝘼𝘿𝙊 𝙇𝘼 𝙁𝙊𝙏𝙊 𝘿𝙀𝙇 𝙂𝙍𝙐𝙋𝙊!!*'}
const smsSrevoke = () => { return '*𝑴𝑰𝑪𝑯𝑰𝑩𝑶𝑻 𝑨𝑵𝑼𝑵𝑪𝑰𝑨 𝑸𝑼𝑬 𝘼𝙃𝙊𝙍𝘼 𝙀𝙎𝙏𝙀 𝙀𝙎 𝙀𝙇 𝙉𝙐𝙀𝙑𝙊 𝙀𝙉𝙇𝘼𝘾𝙀 𝘿𝙀𝙇 𝙂𝙍𝙐𝙋𝙊!!*\n\n*@revoke*'}
...
//_allantilink.js
const smsTextoYT = () => { return 'MichiBot'} 
...
const smsJBInfo2 = () => { return `💖 *La función es estable, sí presenta algún inconveniente comuníquese al número: +51964254634*\n💝`}
